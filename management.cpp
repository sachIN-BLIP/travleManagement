...
public:
    ...
    void getDetails()
    {
        ofstream out("old-customers.txt", ios::app); //open file using append mode to write customer details
        {
           ...
           do {
                ...
                cin >> cusID;
                if (cin.fail() || cusID <= 0) {
                    cout << "Invalid ID. Please enter a valid positive integer ID." << endl;
                    cin.clear();
            ...
            // Validate the name input (should contain only alphabetic characters)
            ...
            do {
                ...
                cin >> age;
                if (cin.fail() || age <= 0) {
                    cout << "Invalid age. Please enter a valid positive integer age." << endl;
                    cin.clear();
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
                }
            } while (age <= 0);
            ...
            do {
                ...
                if (cin.fail() || mobileNo < 1000000000 || mobileNo > 9999999999) {
                    cout << "Invalid mobile number. Please enter a valid 10-digit mobile number." << endl;
                    cin.clear();
                    cin.ignore(numeric_limits<streamsize>::max(), '\n');
                }
            } while (mobileNo < 1000000000 || mobileNo > 9999999999);
            ...
            do {
                cout << "Gender (M/F/O): ";
                cin >> gender;
                gender = toupper(gender[0]); // Convert to uppercase for comparison
                if (gender != "M" && gender != "F" && gender != "O") {
                    cout << "Invalid gender. Please enter 'M', 'F', or 'O'." << endl;
                }
    ...
    bool isValidName(const string &str)
    {
        for (char c : str)
        {
            if (!isalpha(c) && !isspace(c)) // Allow spaces in the name
            {
                return false;
            }
        }
